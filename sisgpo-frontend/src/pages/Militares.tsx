...
export default function Militares() {
  ...
  const handleFileUpload = async (file: File) => {
    ...
    try {
      ...
      toast.success('Arquivo enviado com sucesso! A atualizaÃ§Ã£o serÃ¡ processada em segundo plano.');
      fetchData();
    } catch (err: any) {
  ...
  return (
    <div className="space-y-6">
      ...
      <ConfirmationModal
        ...
        message="Tem certeza de que deseja excluir este militar? Esta aÃ§Ã£o nÃ£o pode ser desfeita."
