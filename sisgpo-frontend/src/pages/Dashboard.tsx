...
import MilitarByObmChart from '@/components/charts/MilitarByObmChart';
...
export default function Dashboard() {
  ...
  const [militarByObmStats, setMilitarByObmStats] = useState<ChartStat[]>([]);
  ...
  const fetchDashboardData = useCallback(async () => {
    ...
    try {
      const [
        ...
        dashboardService.getMilitarStatsPorObm(selectedObm),
      ...
      setMilitarByObmStats(militarByObmStatsData);
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6">
        <MilitarByObmChart data={militarByObmStats} isLoading={isLoading} />
      </div>
