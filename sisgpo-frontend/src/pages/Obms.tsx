...
// --- 1ª CORREÇÃO AQUI ---
// A API envia 'abreviatura', não 'sigla'.
...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase" style={{ width: '20%' }}>Sigla</th>
...
                    <td className="block md:table-cell px-6 py-2 md:py-4 text-sm font-medium text-gray-900 break-words" data-label="Nome:">{obm.nome}</td>
                    ...
                    {/* --- 2ª CORREÇÃO AQUI --- */}
                    {/* Exibe o valor de 'abreviatura' (BOPAR - 1º BBM) */}
